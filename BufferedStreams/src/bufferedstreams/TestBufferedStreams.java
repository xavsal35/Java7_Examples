...
public class TestBufferedStreams {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader bufInput = new BufferedReader(new FileReader("src\\bufferedstreams\\file1.txt"));
             BufferedWriter bufOutput = new BufferedWriter(new FileWriter("src\\bufferedstreams\\file2.txt"))){
